...
//
//       Filename:  C:\Users\arvredd\Desktop\Prac_C_S\Training_Practice\RaviTeja\Nxopen\NxOpen_Practice-main\NxOpen_Practice-main\VSCode\BlockVs\CreationOfBlock\bin\Debug\A_BlockCreation.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: ARVREDD
//              Version: NX 2412
//              Date: 02-11-2026  (Format: mm-dd-yyyy)
//              Time: 14:59 (Format: hh-mm)
//
//==============================================================================
...
public class A_BlockCreation
{
    ...
    public A_BlockCreation()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = AppDomain.CurrentDomain.BaseDirectory + "A_BlockCreation.dlx";
   ...
   /* public static void Main()
    {
        ...
        {
            if(theA_BlockCreation != null)
                theA_BlockCreation.Dispose();
                theA_BlockCreation = null;
        }
    }*/
    //------------------------------------------------------------------------------
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            A_BlockUI.CreateBlock(originPoint, length.ToString(), width.ToString(), height.ToString());
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
    ...
    public int update_cb( NXOpen.BlockStyler.UIBlock block)
    {
        try
        {
            originPoint = point0.GetProperties().GetPoint("Point");
            length = dblLenght.GetProperties().GetDouble("Value");
