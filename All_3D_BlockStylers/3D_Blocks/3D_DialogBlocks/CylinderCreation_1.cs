...
//
//       Filename:  C:\Users\arvredd\Desktop\Prac_C_S\Training_Practice\RaviTeja\Nxopen\Nx_tasks\Cylinder\CylinderCreation_1.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: ARVREDD
//              Version: NX 2412
//              Date: 02-02-2026  (Format: mm-dd-yyyy)
//              Time: 11:26 (Format: hh-mm)
//
//==============================================================================
...
//------------------------------------------------------------------------------
public class CylinderCreation_1
{
    //class members
    ...
    public CylinderCreation_1()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = AppDomain.CurrentDomain.BaseDirectory + "CylinderCreation_1.dlx";
    ...
    public static void Main()
    {
        ...
        {
            if(theCylinderCreation_1 != null)
                theCylinderCreation_1.Dispose();
                theCylinderCreation_1 = null;
        }
    }
    //------------------------------------------------------------------------------
    ...
    public void dialogShown_cb()
    {
        try
        {
            ...
            diameter = dblDiameter.GetProperties().GetDouble("Value");
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            CylinderUI.CreateCylinder(directions, originPoint, diameter.ToString(), height.ToString());
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
