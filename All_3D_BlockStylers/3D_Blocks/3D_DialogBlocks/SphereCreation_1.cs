...
//
//       Filename:  C:\Users\arvredd\Desktop\Prac_C_S\Training_Practice\RaviTeja\Nxopen\Nx_tasks\Sphere\SphereCreation_1.cs
//
...
public class SphereCreation_1
{
    ...
    public SphereCreation_1()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = AppDomain.CurrentDomain.BaseDirectory + "SphereCreation_1.dlx";
    ...
    public static void Main()
    {
        ...
        {
            if(theSphereCreation_1 != null)
                theSphereCreation_1.Dispose();
                theSphereCreation_1 = null;
        }
    }
    //------------------------------------------------------------------------------
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            SphereUI.CreateSphere(originPoint, diameter.ToString());
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
