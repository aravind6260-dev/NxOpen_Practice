...
//
//       Filename:  C:\Users\arvredd\Desktop\Prac_C_S\Training_Practice\RaviTeja\Nxopen\Nx_tasks\Block\BlockCreation_1.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: ARVREDD
//              Version: NX 2412
//              Date: 02-02-2026  (Format: mm-dd-yyyy)
//              Time: 11:18 (Format: hh-mm)
//
//==============================================================================
...
public class Block_Creation_1
{
    ...
    public Block_Creation_1()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDlxFileName = AppDomain.CurrentDomain.BaseDirectory + "BlockCreation_1.dlx";
    ...
    {
        Block_Creation_1 theBlockCreation_1 = null;
        try
        {
            theBlockCreation_1 = new Block_Creation_1();
            // The following method shows the dialog immediately
            theBlockCreation_1.Launch();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
        ...
        {
            if(theBlockCreation_1 != null)
                theBlockCreation_1.Dispose();
                theBlockCreation_1 = null;
        }
    }
    //------------------------------------------------------------------------------
    ...
    public void dialogShown_cb()
    {
        try
        {
            ...
            //length = dblLength.GetProperties().GetDouble("Value");
            //width = dblWidth.GetProperties().GetDouble("Value");
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            BlockUI.CreateBlock(originPoint, length.ToString(), width.ToString(), height.ToString());
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
