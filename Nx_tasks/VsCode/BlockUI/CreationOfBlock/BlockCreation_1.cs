...
public class BlockCreation_1
{
    ...
    {
        BlockCreation_1 theBlockCreation_1 = null;
        try
        {
            theBlockCreation_1 = new BlockCreation_1();
    ...
    public int apply_cb()
    {
        ...
        {
            //---- Enter your callback code here -----
            Class1.CreateBlock(originPoint, length.ToString(), width.ToString(), height.ToString());
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
